<template>
    ...
    <div class="verify-part">
        ...
        >
            Verify</button>
        <img class="github-logo" src="../assets/githublogo.png" alt=""><a href="https://github.com/QuarkChain/open-cryptofate/tree/master/GameVerify/src/components/Dice.js" target="_blank">Dice.js</a>
    </div>
